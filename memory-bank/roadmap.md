...
- **Features**:
  ...
  - FEAT-007: Separate deliverable from question prompt in QUESTIONS catalog (planned) [Level 2]
...
- **Linked Tasks**:
  - TASK-010: Separate deliverable from question prompt in QUESTIONS catalog (planned 2026-05-12)
