...
ActiveRecord::Schema[8.1].define(version: 2026_05_08_120000) do
  ...
  create_table("flow_events", force: :cascade) do |t|
    ...
    t.index(
      ...
      name: "index_flow_events_on_tenant_id_and_event_type_and_occurred_at"
    )
  ...
  create_table("sources", force: :cascade) do |t|
    ...
    t.index(
      ["tenant_id", "domain", "responsibility_key"],
      name: "index_sources_on_tenant_id_and_domain_and_responsibility_key",
      unique: true
    )
  ...
  create_table("tenant_questions", force: :cascade) do |t|
    ...
    t.index(
      ["tenant_id", "key", "catalog_version"],
      name: "idx_on_tenant_id_key_catalog_version_cdd941a015",
      unique: true
    )
